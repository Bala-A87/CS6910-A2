...
args_parser.add_argument('-f', '--filters', type=json.loads, default=[128]*5, help='Number of filters in each convolutional layer')
...
args_parser.add_argument('-w', '--width', type=int, default=128, help='Number of neurons in the fully-connected hidden layer')
args_parser.add_argument('-do', '--dropout', type=float, default=None, help='Dropout to use in the dense layer')
args_parser.add_argument('-ac', '--activation_conv', type=str.lower, default='silu', choices=['relu', 'gelu', 'silu', 'mish'], help='Activation function to use for the convolutional layers') 
args_parser.add_argument('-ad', '--activation_dense', type=str.lower, default='relu', choices=['relu', 'gelu', 'silu', 'mish', 'sigmoid', 'tanh'], help='Activation function to use for the dense hidden layer') 
args_parser.add_argument('-ps', '--pool_size', type=int, default=2, help='Size of maxpooling filter for the last convolutional layer')
